        ...
        child: SlideTransition(
          ...
          child: ValueListenableBuilder<bool>(
            ...
            builder: (context, isLoading, child) {
              if (isLoading) {
                return Center(child: CircularProgressIndicator(color: Theme.of(context).textTheme.bodyMedium?.color ?? Colors.grey));
              }
              ...
              return ValueListenableBuilder<List<AppNotification>>(
                ...
                builder: (context, notifications, child) {
                        ...
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.error_outline,
                                size: 50, color: Theme.of(context).textTheme.bodyMedium?.color ?? Colors.red),
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                  fontSize: 16, color: Theme.of(context).textTheme.bodyMedium?.color ?? Colors.grey),
                            ),
                            const SizedBox(height: 16),
                            ElevatedButton(
                              onPressed: () =>
                                  NotificationService().fetchNotifications(),
                              child: Text('retry'.tr, style: TextStyle(color: Theme.of(context).textTheme.bodyMedium?.color ?? Colors.white)),
                            )
                          ],
                        ),
                      );
                  ...
                  if (filteredNotifications.isEmpty) {
                    return Center(child: Text("no_results_found".tr, style: TextStyle(color: Theme.of(context).textTheme.bodyMedium?.color ?? Colors.grey)));
                  }
