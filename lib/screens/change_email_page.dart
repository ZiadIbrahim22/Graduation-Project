                ...
                Container(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        _buildPasswordField(
                          'current_password'.tr, _passwordController,
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        border: OutlineInputBorder(
          ...
          borderSide: BorderSide(color: Theme.of(context).textTheme.bodyMedium?.color ?? Colors.grey),
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10),
          borderSide: BorderSide(color: Theme.of(context).textTheme.bodyMedium?.color ?? Colors.grey.withValues(alpha: 0.3)),
        ),
