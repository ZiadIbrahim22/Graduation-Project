...
class LocalizationService {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'ai_analysis_subtitle': 'AI analysis in progress',
      'sent_authorities_subtitle': 'Pending review by authorities',
      'team_assigned_subtitle': 'Maintenance team will contact you soon',
      ...
      'Enter': 'Enter',
      'select_your_profile_image': 'Select your profile image',
    ...
    'ar': {
      ...
      'ai_analysis_subtitle': 'جارٍ تحليل البلاغ تلقائيًا',
      'sent_authorities_subtitle': 'قيد المراجعة من الجهات المختصة',
      'team_assigned_subtitle': 'سيتم التواصل معك قريبًا',
      ...
      'failed_to_update_email': 'فشل تحديث البريد الإلكتروني',
